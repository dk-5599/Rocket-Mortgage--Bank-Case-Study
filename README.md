...
|-----|-----------|---------|-------------|---------|---------|------|-----------|-------|-------------|-------|----------|-------------|--------------|----------------|---------------|----------|-------------|-----------------|----|
| 56  | housemaid | married | basic.4y    | no      | no      | no   | telephone | may   | mon         | 999   | 0        | nonexistent | 1.1          | 93.994         | -36.4         | 4.857    | 5191.0      | 0.932750        | no |
| 57  | services  | married | high.school | unknown | no      | no   | telephone | may   | mon         | 999   | 0        | nonexistent | 1.1          | 93.994         | -36.4         | 4.857    | 5191.0      | 0.953579        | no |
| 37  | services  | married | high.school | no      | yes     | no   | telephone | may   | mon         | 999   | 0        | nonexistent | 1.1          | 93.994         | -36.4         | 4.857    | 5191.0      | 0.945724        | no |
| 40  | admin.    | married | basic.6y    | no      | no      | no   | telephone | may   | mon         | 999   | 0        | nonexistent | 1.1          | 93.994         | -36.4         | 4.857    | 5191.0      | 0.933875        | no |
| 56  | services  | married | high.school | no      | no      | yes  | telephone | may   | mon         | 999   | 0        | nonexistent | 1.1          | 93.994         | -36.4         | 4.857    | 5191.0      | 0.940996        | no |
...
|-------|--------|---------|-----------|---------|---------|-------|---------|-------|-------------|----------|----------|-------|----------|----------|--------------|----------------|---------------|-----------|-------------|-----------------|------|
| int64 | object | object  | object    | object  | object  | object| object  | object| object      | int64    | int64    | int64 | int64    | object   | float64      | float64        | float64       | float64   | float64     | float64         | object |
